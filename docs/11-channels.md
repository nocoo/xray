...
At content widths of at least 1180px, standard reading width displays a secondary right-hand column. Both side panels share a 345.6px token-based width, matching rounded borders, aligned headings and subdued Basalt count badges; the related-links column and Sheet are 20% wider than their original widths. The three cards share one top edge with a 12px gap, independently scrolling content, quieter side surfaces and the brightest central document. The header link icon can hide/show it. Full-width reading and narrow screens use a right-hand Basalt Sheet, preserving the document width and restoring focus on close. Reader shortcuts do not intercept interactions inside the related-links panel.
