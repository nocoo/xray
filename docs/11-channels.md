...
At content widths of at least 1024px, standard reading width displays a secondary right-hand column, including common 1366px and 1440px desktop windows. Both side panels share a responsive 240–345.6px token-based width, reserving at least 448px for the reader, with matching rounded borders, aligned headings and subdued Basalt count badges. The three cards share one top edge with a 12px gap, independently scrolling content, quieter side surfaces and the brightest central document. The header link icon can hide/show it and its tooltip includes the source count. Full-width reading and narrow screens use a right-hand Basalt Sheet, preserving the document width and restoring focus on close. Reader shortcuts do not intercept interactions inside the related-links panel.
