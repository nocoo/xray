import { loadRawTweets, loadAnalyzeOutput, nowISO, saveWatchlistReport, type Tweet } from "./lib/utils";
...
function buildEngagementLabel(tweet: Tweet): string {
  ...
  const quotes = tweet.metrics.quote_count || 0;
  const views = tweet.metrics.view_count || 0;
