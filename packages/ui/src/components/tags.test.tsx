...
test("assignment opens a popover, selects existing tags and creates with a name preview", async () => {
...
test("assignment errors retain drafts without nested forms", async () => {
	vi.mocked(api.fetchTags).mockResolvedValue([tag]);
