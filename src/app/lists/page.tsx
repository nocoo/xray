      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            View your Twitter lists. Requires Twitter cookie authentication.
          </p>
        </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <FeatureItem
                ...
                title="Twitter Lists"
                api="POST /v1/twitter/user/lists"
                description="Browse your curated Twitter lists and their members"
              />
            </div>
          </div>
        </div>
